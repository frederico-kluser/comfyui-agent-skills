...
| [`text-to-music-api`](workflows-api/text-to-music-api/) | Gera **trilha instrumental/ambient** (loopável) por API — comercializável **para sempre** (ACE-Step MIT/Apache) | `fishaudio/ace-step-1.5` (Replicate) · `fal-ai/ace-step` · core local | Replicate / fal / local | 🟡 |
