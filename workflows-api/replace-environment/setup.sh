#!/usr/bin/env bash
# setup.sh — replace-environment (trocar o AMBIENTE/FUNDO mantendo o sujeito, por API)
...
NODES=(
  ...
  "https://github.com/kijai/ComfyUI-KJNodes"      # ImageResizeKJ + GrowMaskWithBlur
)
WORKFLOWS=(
  "00_LEIA-ME_comece_aqui.json" "01_prompt_nanobanana.json" "02_prompt_kontext.json"
  "03_area_nanobanana.json" "04_area_kontext.json"
)
...
echo "============================================"
echo " replace-environment pronto. Reinicie o ComfyUI."
echo " Nós vermelhos? Manager > Install Missing (fal-API, KJNodes)."
echo " MaskEditor é nativo (botão direito no Load Image). Nós 03/04: grupo de máscara vem em bypass."
