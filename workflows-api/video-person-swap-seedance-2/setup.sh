#!/usr/bin/env bash
# setup.sh — video-person-swap-seedance-2
#
...
REQUIRED_NODES=(ByteDance2ReferenceNode ByteDanceCreateImageAsset ByteDanceCreateVideoAsset GeminiNode LoadVideo SaveVideo PreviewAny StringConcatenate)
